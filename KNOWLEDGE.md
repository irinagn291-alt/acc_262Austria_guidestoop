...
- Invariant (unit-test this): One completion/day. Streak continues iff yesterday. Unlock next node at streak ≥ 3. XP += value; level = 1 + totalXP/100. Boss: 5 completions → bonus XP.
- Empty: The path is closed. Finish three days to open the next node.
- Fake that fails: Cyca rings, or a quest list without the 3-day gate.
